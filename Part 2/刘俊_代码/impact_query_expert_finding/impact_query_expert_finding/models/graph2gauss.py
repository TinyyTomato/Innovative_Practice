...
import numpy as np
import impact_query_expert_finding.language_models
...
class Model:
    ...
    def fit(self, X, M):
        ...
        self.tf_vectors = normalize(impact_query_expert_finding.preprocessing.text.vectorizers.get_tf_dictionary(self.vocab),
                                    norm='l1', axis=1)
    ...
    def get_embeddings_new(self, M):
        tf_v = impact_query_expert_finding.preprocessing.text.vectorizers.get_tf_N(self.vocab, M)
